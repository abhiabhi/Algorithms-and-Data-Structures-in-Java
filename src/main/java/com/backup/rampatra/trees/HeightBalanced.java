package com.backup.rampatra.trees;

import com.backup.ctci.treesandgraphs.TreeNode;
import com.backup.rampatra.base.BinaryNode;
import com.backup.rampatra.base.BinarySearchTree;
...
public class HeightBalanced<E extends Comparable<E>> extends BinarySearchTree<E> {
     ...
     * optimized approach see {@link com.backup.ctci.treesandgraphs.CheckBalanced#isBalancedOptimized(TreeNode)} where while
